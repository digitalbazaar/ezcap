...
export class ZcapClient {
  /**
   * An object that can make HTTPS requests that include capability invocations.
   *
   ...
   *   `.sign()` function and key `id` parameter that will be used for
   *   signing capability delegations.
   *
  ...
  /**
   * Delegates an Authorization Capability to a specified delegate.
   *
   * @param {object} options - The options to use.
