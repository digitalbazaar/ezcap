...
export class ZcapClient {
   ...
   * @param {object} options.defaultHeaders - The default HTTP headers to
   *   include in every invocation request.
   ...
   */
  constructor(
    {baseUrl, defaultHeaders = {}, agent, invocationSigner} = {}) {
  ...
  async invoke({
    ...
    return httpClient.post(absUrl, request);
  }
