...
export class ZcapClient {
   ...
   *   if it is a root zcap but `invocationTarget` must be specified if using
   *   a string; if not specified, this will be auto-generated as a root zcap
   *   for the given `invocationTarget`.
   ...
   */
  async delegate({
    capability, targetDelegate, invocationTarget, expires,
    allowedActions = []
  } = {}) {
